...
export default function Tarjeta({
  ...
  return (
    <div
      className={`relative rounded-lg shadow-lg content-center   ${
        darkMode
          ? "shadow-stone-700  hover:shadow-stone-50 opacity-85"
          : "shadow-stone-400  hover:shadow-stone-900 opacity-95"
      } transition-transform duration-300 ease-in-out overflow-hidden ${className} h-48 sm:h-48 md:h-64 lg:h-80 xl:h-96`} // Mantener altura específica
    ...
    >
      ...
      <a href={direccion} className="relative z-20 p-4 text-center  shadow-2xl">
        <h2
          className={`lg:text-3xl md:text-2xl sm:text-lg font-extrabold md:font-bold ${
        ...
        <p
          className={`font-extrabold lg:text-2xl md:text-xl md:font-bold sm:text-md py-4 ${
            darkMode ? "text-gray-200" : "text-white shadow "
          }`}
        >
          {info}
        </p>
