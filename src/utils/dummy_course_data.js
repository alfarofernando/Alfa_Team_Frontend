const dummy_course_data = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        type: "video",
        content: "https://example.com/videos/install-python.mp4",
      },
    ],
  },
  {
    ...
    description:
      "Amplía tus conocimientos de Python con este curso intermedio.",
    ...
    lessons: [
      ...
      },
      {
        ...
        type: "video",
        content: "https://example.com/videos/python-errors.mp4",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        ...
        type: "text",
        content: "La POO es un paradigma de programación...",
      },
      {
        id: 2,
        title: "Decoradores avanzados",
        type: "video",
        content: "https://example.com/videos/python-decorators.mp4",
      },
    ],
  },
  {
    ...
    description:
      "Aprende JavaScript desde cero y comienza a crear tus primeras aplicaciones web.",
    ...
    lessons: [
      {
        ...
        type: "text",
        content: "JavaScript es un lenguaje dinámico...",
      },
      {
        id: 2,
        title: "Manipulación del DOM",
        type: "video",
        content: "https://example.com/videos/dom-manipulation.mp4",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        id: 1,
        title: "Closures y scopes",
        type: "text",
        content: "Los closures permiten crear funciones con ámbito léxico...",
      },
      {
        id: 2,
        title: "Promesas y Async/Await",
        type: "video",
        content: "https://example.com/videos/js-promises.mp4",
      },
    ],
  },
